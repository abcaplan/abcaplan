## Hi there, I'm Bogdan 😊
### Aspiring Data Analyst | Newcastle upon Tyne
---

🔭 **Currently up to**: Turning raw data into magic with **visualisation dashboards**. <br>
🌱 **Leveling up in**: **Excel**, **SQL**, **Tableau**, **Python**, **Power BI**. <br>
👯 **Collaboration goals**: Crafting **data-driven projects** that achieve great solutions to real-world problems. <br>
🤔 **Need help with**: Advanced **AI concepts** and **machine learning algorithms**. <br>
...
![Unreal Engine 5](https://img.shields.io/badge/Unreal%20Engine%205-000000?style=for-the-badge&logo=unreal-engine&logoColor=white)
